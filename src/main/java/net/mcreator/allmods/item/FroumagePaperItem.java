...
public class FroumagePaperItem extends AllmodsModElements.ModElement {
	@ObjectHolder("allmods:froumage_paper")
	public static final Item block = null;
	public FroumagePaperItem(AllmodsModElements instance) {
		super(instance, 3);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("froumage_paper");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Un papier de Froumage"));
		}
	}
}
